...
with open('states.csv', 'w') as f:
	f.write("sid,stname,stabbrev\n")
	for sid in range(50):
		stname = state_names[sid]
		stabbr = state_abbrevs[sid]
		f.write("{},{},{}\n".format(sid+1,stname,stabbr))
